...
3. Network config lives in [hardware/firmware/main/wifi_client.h](hardware/firmware/main/wifi_client.h) (SSID `jetson_nano_wifi`, password `team1-falcon`, host `192.168.20.1`, port `5000`).
